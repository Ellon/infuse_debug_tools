...
axes[0].plot(frontLeftStamps / 1000000.0, (frontRightStamps - frontLeftStamps) / 1000.0, label="front stamp difference (right-left)")
...
axes[1].plot(rearLeftStamps / 1000000.0, (rearRightStamps  - rearLeftStamps)  / 1000.0,  label="rear stamp difference (right-left)")
...
axes[2].plot(navLeftStamps / 1000000.0, (navRightStamps   - navLeftStamps)   / 1000.0,   label="nav stamp difference (right-left)")
...
axes[0].plot(frontLeftStamps[1:] / 1000000.0, (frontLeftStamps[1:] - frontLeftStamps[:-1]) / 1000000.0, label="front left time between successive frames")
axes[0].legend(loc="upper right")
axes[0].set_xlabel("left image stamp (s)")
...
axes[1].plot(rearLeftStamps[1:] / 1000000.0, (rearLeftStamps[1:] - rearLeftStamps[:-1]) / 1000000.0,  label="rear left time between successive frames")
axes[1].legend(loc="upper right")
axes[1].set_xlabel("left image stamp (s)")
...
axes[2].plot(navLeftStamps[1:] / 1000000.0, (navLeftStamps[1:] - navLeftStamps[:-1]) / 1000000.0,   label="nav left time between successive frames")
axes[2].legend(loc="upper right")
axes[2].set_xlabel("left image stamp (s)")
